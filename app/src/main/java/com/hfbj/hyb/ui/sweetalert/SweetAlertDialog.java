...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    public SweetAlertDialog setTitleText(int stringId){
        return setTitleText(getContext().getResources().getString(stringId));
    }
    ...
    public SweetAlertDialog setContentText(int stringId){
