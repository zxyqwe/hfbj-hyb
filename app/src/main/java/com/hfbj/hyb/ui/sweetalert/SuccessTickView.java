...
public class SuccessTickView extends View {
    ...
    private final float CONST_RADIUS = dip2px(1.2f);  //对号线条弧度
    private final float CONST_RECT_WEIGHT = dip2px(3);  //对号线条区域宽度

    private final float CONST_LEFT_RECT_W = dip2px(15);  //对号左侧部分长度
    private final float CONST_RIGHT_RECT_W = dip2px(25);  //对号右侧部分长度


    private final float MIN_LEFT_RECT_W = dip2px(3.3f);  //对号左侧部分最小长度
    private final float MAX_RIGHT_RECT_W = CONST_RIGHT_RECT_W + dip2px(6.7f);  //对号右侧部分最大长度

    private float mMaxLeftRectWidth;
    private float mLeftRectWidth;
    private float mRightRectWidth;
    private boolean mLeftRectGrowMode;  //左侧长度是否可增长
